...
const Content = props => {
  ...
  //캔버스 관련 변수
        ...
        //타이틀 버튼 구현
        const [buttonSrc,setButtonSrc] = useState('/resource/pages/main/startButton.png');
  ...
  const draw = (ctx) => {
    ...
    mainbackg.src = '/resource/pages/main/mainbackg.jpg';
  ...
  const mainPage = (ctx) => {
    ...
    mainlogo.src = '/resource/pages/main/mainlogo.png';
    ctx. drawImage( mainlogo, 0,0, cWidth ,cHeight );

    //게임 설명
    let subtitle = new Image();
    subtitle.src = '/resource/pages/main/subtitle.png';
    ...
    canvas.onmousedown =  (e) => {
        ...
        if( e.layerX > 281 && e.layerX < 544 && e.layerY<411 && e.layerY >370){
            setButtonSrc('/resource/pages/main/clickedButton.png');
        }
      }
    canvas.onmouseup = ( e ) => {
        if(buttonSrc == '/resource/pages/main/clickedButton.png'){
            setButtonSrc('/resource/pages/main/startButton.png');
            setnowPage('game');
        }
    }
  ...
  const gamePage  = (ctx) =>{
    ...
    //분류 창
    let core = new Image();
    core.src = '/resource/pages/game/gameCore.png';
    ...
    if(!items_tmp[0].success){
      let past = new Image();
      past.src = '/resource/pages/game/things/파스퇴르.png';
    ...
    if(!items_tmp[1].success){
      let icis = new Image();
      icis.src = '/resource/pages/game/things/아이시스.png';
    ...
    if(!items_tmp[2].success){
      let dduck = new Image();
      dduck.src = '/resource/pages/game/things/떡볶이.png';
    ...
    if(!items_tmp[3].success){
      let xi = new Image();
      xi.src = '/resource/pages/game/things/자일리톨.png';
    ...
    if(!items_tmp[4].success){
      let xi_g = new Image();
      xi_g.src = '/resource/pages/game/things/자껍.png';
    ...
    if(!items_tmp[5].success){
      let drug = new Image();
      drug.src = '/resource/pages/game/things/알약.png';
    ...
    if(!items_tmp[6].success){
      let water = new Image();
      water.src = '/resource/pages/game/things/좋은물.png';
  ...
  const descriptionPage = (ctx) => {
    ...
    descBackg.src = '/resource/pages/description/'+descItems[descNum];
  ...
  const successPage = (ctx) =>{
    ...
    successBackg.src = '/resource/pages/success/success.png';
